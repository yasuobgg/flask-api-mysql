...
def create_emp():
    ...
    #tat ca cac du lieu khoi rao bang None
    ...
    #lay du lieu ra tu chuoi json moi doc duoc
    if _json:
        if 'name' in _json:
            _name = _json['name']   
        if 'email' in _json:
...
def update_emp():
    ...
    if k==1 and _name and _email and _phone and _address and _id and request.method == 'PUT':
